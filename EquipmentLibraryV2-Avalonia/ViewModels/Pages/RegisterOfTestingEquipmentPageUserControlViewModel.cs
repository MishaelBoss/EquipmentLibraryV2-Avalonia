...
public partial class RegisterOfTestingEquipmentPageUserControlViewModel : ViewModelBase, IRecipient<RefreshDataMessage>, IDisposable
{
    ...
    {
        Log.Information("Download PDF (stub)");
    }

    [RelayCommand]
    private void DownloadExcel()
    {
        Log.Information("Download Excel (stub)");
    }
    ...
    public RegisterOfTestingEquipmentPageUserControlViewModel()
    {
        Log.Information("RegisterOfTestingEquipmentPageUserControlViewModel created");
